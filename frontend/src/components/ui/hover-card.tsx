...
const HoverCardContent = React.forwardRef<
  HTMLDivElement,
  Omit<HoverCardPrimitive.Popup.Props, "side" | "sideOffset" | "align" | "alignOffset"> &
...
>(({ className, align = "center", sideOffset = 4, side, alignOffset, ...props }, ref) => (
  <HoverCardPrimitive.Portal><HoverCardPrimitive.Positioner side={side} align={align} sideOffset={sideOffset} alignOffset={alignOffset}>
