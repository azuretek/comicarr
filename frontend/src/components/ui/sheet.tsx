...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition-[opacity,transform] ease-in-out duration-300 data-starting-style:opacity-0 data-ending-style:opacity-0",
  {
    variants: {
      side: {
